  ...
  Client = (function() {
    ...
    */
    ...
    Client.prototype._listen_events = function() {
      var _this = this;
      this._listen_to('succesfully connected', function(data) {
        _this.sessionId = data.id;
        if (_this.settings.onConnect) {
          return _this.settings.onConnect(data);
        }
      });
    ...
    Client.prototype._listen_to = function(event, callback) {
      ...
      return this.socket.on(event, function(data) {
        if (callback) {
          return callback(_this._format_message(data));
        }
      });
    };
